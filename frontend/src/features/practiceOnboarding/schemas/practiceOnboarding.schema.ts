...
export const practiceOnboardingSchema = z.object({
  ...
  proposedUrl: z.string().min(1, "Proposed URL is required"),
  ...
  practicePhoneNumber: z.string().min(1, "Practice phone number is required"),
  ...
  invoiceHeader: z.string().min(1, "Invoice header is required"),
  invoiceFooter: z.string().min(1, "Invoice footer is required"),
  publicEmail: z
    .string()
